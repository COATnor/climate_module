...
# From Frost, it downloads the elements sum(precipitation_amount P1Y) with timeOffset PT6H, and mean(air_temperature P1D) with timeOffset PT0H (preferred) or PT6H.
